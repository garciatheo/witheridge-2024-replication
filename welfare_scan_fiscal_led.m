...
base_mod    = 'welfare_base_fiscal_led.mod';   % base Dynare model
phi_pi_vals = 0:0.1:0.9;
outdir      = 'results_phi_scan_fiscal_led';
...
for i = 1:numel(phi_pi_vals)
    ...
    tmpname = sprintf('tw_phi_%02d', round(10*phi));   % e.g. tw_phi_00, tw_phi_01, ...
...
title('Welfare - Markup shock (fiscal-led)');
...
xlabel('\phi_\pi'); ylabel('Welfare Loss');
title('Welfare - Productivity shock (fiscal-led)');
grid on; legend('Location','best');

// =====================================================================
//  Witheridge (2024) - Section 6 - Monetary-led regime
//  Replication: Theo Garcia & Ana Victoria Pelliccione
//
//  Welfare base model (monetary-led). Used by welfare_scan_monetary_led.m
//  to produce Figure 9(b).
// =====================================================================
...
gamma_d = 1.5;    // monetary-led regime: strong response to debt
gamma_y = 0.0;
...
stoch_simul(order=1, irf=20) u a r pi piH ygap d tau;
